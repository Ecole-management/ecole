...
<div class="admin-box">
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
			...
			<div class="control-group <?php echo form_error('enrollment_no') ? 'error' : ''; ?>">
				<?php echo form_label('Enrollment No.'. lang('bf_form_label_required'), 'enrollment_no', array('class' => 'control-label') ); ?>
				<div class='controls'>
					<input id='enrollment_no' type='text' name='enrollment_no' maxlength="50" value="<?php echo set_value('enrollment_no', isset($student['enrollment_no']) ? $student['enrollment_no'] : ''); ?>" />
				</div>
			</div>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('student_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
