...
<div class="admin-box">
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
			<div class="control-group <?php echo form_error('section') ? 'error' : ''; ?>">
				<?php echo form_label('Student name', 'student_id', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="control-group <?php echo form_error('optional_subject') ? 'error' : ''; ?>">
				<?php echo form_label('Optional subject name'. lang('bf_form_label_required'), 'optional_subject', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('student_session_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
